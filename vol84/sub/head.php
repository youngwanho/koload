...
$twoDepth = ""; //koroad/vol84 폴더 내
$threeSubDepth = ""; //koroad/vol84/sub 폴더 내
$headerCss = '';
$mainFlag = false;
...
<head>
  ...
  <meta property="og:url" content="http://news.koroad.or.kr/koroad/vol84/">
  <meta property="og:description" content="<?= $meta_description ?>" />
  <meta property="og:image" content="<?= $twoDepth ?>images/sns/sns_img_84.jpg" />
  <meta name="twitter:title" content="<?= $meta_title ?> " />
  <meta name="twitter:site" content="신호등" />
  <meta name="twitter:description" content="<?= $meta_description ?>" />
  <meta name="twitter:image" content="<?= $twoDepth ?>images/sns/sns_img_84.jpg" />
  <meta name="nate:title" content="<?= $meta_title ?>" />
  <meta name="nate:site_name" content="신호등" />
  <meta name="nate:url" content="http://news.koroad.or.kr/koroad/vol84/" />
  <meta name="nate:description" content="<?= $meta_description ?>" />
  <meta name="nate:image" content="<?= $twoDepth ?>/images/sns/sns_img_84.jpg" />
  <title><?= $meta_title ?></title>
  <link href="../images/common/favicon.ico" rel="shortcut icon" type="image/x-icon" />

  <link rel="stylesheet" href="<?= $twoDepth ?>css/swiper.min.css" />
  <link rel="stylesheet" href="<?= $twoDepth ?>css/style.css" />
